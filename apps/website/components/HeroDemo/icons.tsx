...
export function IconStar(p: IconProps & { filled?: boolean }) {
  const { filled, ...rest } = p;
  return (
    <svg {...base(rest.size, rest.strokeWidth, rest.className, rest.style)} fill={filled ? 'currentColor' : 'none'}>
...
export function IconX(p: IconProps) {
  return (
    <svg {...base(p.size, p.strokeWidth ?? 2.2, p.className, p.style)}>
...
export function IconGrip(p: IconProps) {
  return (
    <svg {...base(p.size, p.strokeWidth, p.className, p.style)} fill="currentColor" stroke="none">
